...
概念定义：- 整数类型：An integer is a datum of integral data type, a data type that represents some range of mathematical integers.
        - Represented as a group of binary digits (bits).
